    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                Text("Streak · Rush · Limits").font(.largeTitle.weight(.bold))
                    ...
                    VStack(spacing: 12) {
                        ...
                        HStack {
                            ...
                            VStack(spacing: 4) {
                                ...
                                Text(premium ? "premium bypasses limits" : "free tier").font(.caption).foregroundStyle(.secondary)
                ...
                Card(title: "Puzzle Rush best score") {
                    VStack(spacing: 12) {
                        ...
                        HStack {
                            ...
                            Text("Stored best").foregroundStyle(.secondary)

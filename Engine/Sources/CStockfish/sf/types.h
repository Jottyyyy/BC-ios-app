...
// BIYAHERONG PATCH (the only edit to the vendored Stockfish tree). SwiftPM never runs the Makefile
// below, and none of the switches it would set are auto-detected — see ../sfconfig.h, which sets
// them from the preprocessor's own architecture macros instead. types.h is the right host because
// every translation unit reaches it. tools/qa/stockfish_vendor_check.js fails if this line is lost.
    #include "../sfconfig.h"
